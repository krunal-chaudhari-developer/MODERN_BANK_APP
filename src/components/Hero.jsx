...
const Hero = () => (
  <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
      ...
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Labore earum eius perspiciatis, facere vero, odio hic a modi, autem aut ducimus delectus voluptates quos facilis laboriosam architecto soluta aperiam excepturi.</p>
    </div>
